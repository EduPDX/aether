...
SERVER_PROPERTIES_SCHEMA = ConfigSchema(
    ...
    fields=[
        ...
        _f(
            "enable-status",
            "Aparecer na lista de servidores",
            type=_BOOL,
            default="true",
            section="Geral",
            advanced=True,
        ...
        _f(
            "hide-online-players",
            "Ocultar lista de jogadores online",
            type=_BOOL,
            default="false",
            section="Geral",
            advanced=True,
        ...
        _f(
            "player-idle-timeout",
            "Expulsar por inatividade (minutos, 0 = nunca)",
            type=_INT,
            default="0",
            section="Geral",
            minimum=0,
        ...
        _f(
            "enable-command-block", "Blocos de comando", type=_BOOL, default="false", section="Jogo"
        ),
        _f(
            "force-gamemode",
            "Forçar modo de jogo ao entrar",
            type=_BOOL,
            default="false",
            section="Jogo",
            advanced=True,
        ...
        _f(
            "max-world-size",
            "Tamanho máximo do mundo (blocos)",
            type=_INT,
            default="29999984",
            section="Mundo",
            minimum=1,
        ...
        _f(
            "max-tick-time",
            "Tempo máximo por tick (ms, -1 desliga o watchdog)",
            type=_INT,
            default="60000",
            section="Desempenho",
            advanced=True,
        ...
        _f(
            ...
            "Limiar de compressão de rede (bytes)",
            type=_INT,
            default="256",
            section="Desempenho",
            advanced=True,
        ...
        _f(
            "enforce-whitelist",
            "Expulsar quem sair da whitelist",
            type=_BOOL,
            default="false",
            section="Acesso",
        ),
        ...
        _f(
            "op-permission-level",
            "Nível de permissão dos operadores",
            type=_ENUM,
            default="4",
            options=["1", "2", "3", "4"],
            section="Acesso",
        ...
        _f(
            ...
            "Enviar saída do console aos operadores",
            type=_BOOL,
            default="true",
            section="Acesso",
            advanced=True,
        ...
        _f(
            ...
            advanced=True,
            description="Sem isso o jogador rebaixa o pacote a cada entrada",
        ),
        _f(
